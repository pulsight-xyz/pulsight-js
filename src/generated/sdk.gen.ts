 ...
 */
export const getMintsByPubkeyLive = <ThrowOnError extends boolean = false>(options: Options<GetMintsByPubkeyLiveData, ThrowOnError>) => (options.client ?? client).get<GetMintsByPubkeyLiveResponses, GetMintsByPubkeyLiveErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
