 ...
 */
export const getHealthLive = <ThrowOnError extends boolean = false>(options?: Options<GetHealthLiveData, ThrowOnError>) => (options?.client ?? client).get<GetHealthLiveResponses, unknown, ThrowOnError>({ url: '/api/health/live', ...options });
 ...
 * Program logo image
 */
export const getProgramLogosByProgramId = <ThrowOnError extends boolean = false>(options: Options<GetProgramLogosByProgramIdData, ThrowOnError>) => (options.client ?? client).get<GetProgramLogosByProgramIdResponses, GetProgramLogosByProgramIdErrors, ThrowOnError>({ url: '/api/program-logos/{programID}', ...options });
 ...
 */
export const getProgramsLeaderboard = <ThrowOnError extends boolean = false>(options?: Options<GetProgramsLeaderboardData, ThrowOnError>) => (options?.client ?? client).get<GetProgramsLeaderboardResponses, GetProgramsLeaderboardErrors, ThrowOnError>({ url: '/api/programs/leaderboard', ...options });

/**
 * Programs board summary
 *
 ...
 */
export const getProgramsSummary = <ThrowOnError extends boolean = false>(options?: Options<GetProgramsSummaryData, ThrowOnError>) => (options?.client ?? client).get<GetProgramsSummaryResponses, GetProgramsSummaryErrors, ThrowOnError>({ url: '/api/programs/summary', ...options });
 ...
 */
export const getProgramsByProgramIdDaily = <ThrowOnError extends boolean = false>(options: Options<GetProgramsByProgramIdDailyData, ThrowOnError>) => (options.client ?? client).get<GetProgramsByProgramIdDailyResponses, GetProgramsByProgramIdDailyErrors, ThrowOnError>({ url: '/api/programs/{program_id}/daily', ...options });
 ...
 */
export const getTokenFilters = <ThrowOnError extends boolean = false>(options?: Options<GetTokenFiltersData, ThrowOnError>) => (options?.client ?? client).get<GetTokenFiltersResponses, GetTokenFiltersErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const postTokenFilters = <ThrowOnError extends boolean = false>(options: Options<PostTokenFiltersData, ThrowOnError>) => (options.client ?? client).post<PostTokenFiltersResponses, PostTokenFiltersErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/api/token-filters/',
    ...options,
    headers: {
 ...
 */
export const deleteTokenFiltersById = <ThrowOnError extends boolean = false>(options: Options<DeleteTokenFiltersByIdData, ThrowOnError>) => (options.client ?? client).delete<DeleteTokenFiltersByIdResponses, DeleteTokenFiltersByIdErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const getTokenFiltersById = <ThrowOnError extends boolean = false>(options: Options<GetTokenFiltersByIdData, ThrowOnError>) => (options.client ?? client).get<GetTokenFiltersByIdResponses, GetTokenFiltersByIdErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/api/token-filters/{id}',
    ...options
});
 ...
 */
export const putTokenFiltersById = <ThrowOnError extends boolean = false>(options: Options<PutTokenFiltersByIdData, ThrowOnError>) => (options.client ?? client).put<PutTokenFiltersByIdResponses, PutTokenFiltersByIdErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
    url: '/api/token-filters/{id}',
    ...options,
    headers: {
 ...
 */
export const postTradersCopyability = <ThrowOnError extends boolean = false>(options: Options<PostTradersCopyabilityData, ThrowOnError>) => (options.client ?? client).post<PostTradersCopyabilityResponses, PostTradersCopyabilityErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
 ...
 */
export const getTradersByWalletAddressNeighbours = <ThrowOnError extends boolean = false>(options: Options<GetTradersByWalletAddressNeighboursData, ThrowOnError>) => (options.client ?? client).get<GetTradersByWalletAddressNeighboursResponses, unknown, ThrowOnError>({ url: '/api/traders/{walletAddress}/neighbours', ...options });
...
/**
 * Price impact of a wallet's own fills
 */
export const getTradersByWalletAddressPriceImpact = <ThrowOnError extends boolean = false>(options: Options<GetTradersByWalletAddressPriceImpactData, ThrowOnError>) => (options.client ?? client).get<GetTradersByWalletAddressPriceImpactResponses, GetTradersByWalletAddressPriceImpactErrors, ThrowOnError>({ url: '/api/traders/{walletAddress}/price-impact', ...options });

/**
 * Landed-vs-failed reliability of a wallet's transactions
 */
export const getTradersByWalletAddressReliability = <ThrowOnError extends boolean = false>(options: Options<GetTradersByWalletAddressReliabilityData, ThrowOnError>) => (options.client ?? client).get<GetTradersByWalletAddressReliabilityResponses, GetTradersByWalletAddressReliabilityErrors, ThrowOnError>({ url: '/api/traders/{walletAddress}/reliability', ...options });
