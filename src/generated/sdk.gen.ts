 ...
 */
export const getBacktestsByIdDeclines = <ThrowOnError extends boolean = false>(options: Options<GetBacktestsByIdDeclinesData, ThrowOnError>) => (options.client ?? client).get<GetBacktestsByIdDeclinesResponses, GetBacktestsByIdDeclinesErrors, ThrowOnError>({
    security: [{ name: 'Authorization', type: 'apiKey' }],
